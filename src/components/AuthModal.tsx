  ...
  return (
    ...
    >
      <div className="modal auth-modal">
        ...
        <div className="auth-mode-toggle mono">
          <button
            type="button"
        ...
        {errorMessage && (
          <div className="auth-error-banner mono">{errorMessage}</div>
        )}

        {/* Disabled OAuth2 Providers */}
        ...
        <div className="auth-divider">
          ...
          <span className="auth-divider-text mono">or continue with credentials</span>
          <span className="auth-divider-line"></span>
        </div>

        {/* Active Email & Password Form */}
        <form onSubmit={handleSubmit} className="auth-form">
          {authMode === 'signup' && (
            <div className="field">
              <label className="mono" htmlFor="signupUsername">
                Username
              </label>
              <input
                ref={inputRef}
          ...
          {authMode === 'signup' ? (
            <div className="field">
              <label className="mono" htmlFor="signupEmail">
                Email Address
              </label>
              <input
                type="email"
            ...
            <div className="field">
              <label className="mono" htmlFor="signinIdentifier">
                Email or Username
              </label>
              <input
                ref={inputRef}
          ...
          <div className="field">
            <label className="mono" htmlFor="authPassword">
              Password
            </label>
            <input
              type="password"
